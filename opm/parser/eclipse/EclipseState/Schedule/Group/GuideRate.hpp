...
public:
    ...
    void compute(const std::string &wgname, size_t report_step, double sim_time,
                 bool time_to_update, double oil_pot, double gas_pot, double wat_pot);
    ...
    bool timeToUpdate(double sim_time, double time_interval) const;

private:
    void well_compute(const std::string &wgname, size_t report_step, double sim_time, bool time_to_update,
                      double oil_pot, double gas_pot, double wat_pot);
    void group_compute(const std::string& wgname, size_t report_step, double sim_time, bool time_to_update,
                       double oil_pot, double gas_pot, double wat_pot);

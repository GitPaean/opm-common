...
#
get_filename_component(filename "/home/runner/work/opm-common/opm-common/build_test/_deps/cjson-subbuild/cjson-populate-prefix/src/v1.7.16.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/opm-common/opm-common/build_test/_deps/cjson-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cjson-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cjson-populate${i}")
